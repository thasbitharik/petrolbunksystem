        ...
        <div class="menu">
            <ul class="list">
                ...
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-apps"></i><span>Add</span></a>
                    <ul class="ml-menu">
                        <li><a href="{{ route('product_type.index') }}">Fuel Type</a></li>
                        <li><a href="{{ route('pump.index') }}">Pump</a></li>
                        <li><a href="{{ route('pump_product.index') }}">Pump Product Type</a></li>
                        <li><a href="{{ route('product_purchase.index') }}">Purchase</a></li>
                        <li><a href="{{ route('unit_price.index') }}">Price Per Unit</a></li>
