            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="updateProductTypeForm"
                        action="{{ route('product_purchase.update', ['id' => $product->id]) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <input type="hidden" id="update_product_type_id" name="id" value="{{ $product->id }}">
                        <div style="display: flex">
                            <div>
                                <label for="tableName">Product Name </label>
                                <select class="form-select text-white-dark" name="product_type_id" id="product_type_id"
                                    required>
                                    <option value="" disabled selected>Select Product Name</option>
                                    @foreach ($selectProduct as $product)
                                    <option name="SelectParent" class="pro-type" value="{{ $product->id }}" {{
                                        $product->
                            ...
                            <div class="form-group">
                                <label for="purchase_amount">Purchase Amount</label>
                                <input type="text" class="form-control" id="purchase_amount" name="purchase_amount"
                                    value="{{ $product->purchase_amount }}" required>
                            </div>
                            <div class="form-group">
                                <label for="supplier_name">Supplier Name</label>
                                <input type="text" class="form-control" id="supplier_name" name="supplier_name"
...
$('.edit-product-type').on('click', function () {
        ...
        function populateUpdateModal(id, productType, qty,purchase_amount,supplier_name) {
            $('#update_product_type_id').val(id);
            // Set the value of product type dropdown
            $('#product_type_id').empty().append($('<option>', {
                value: productType,
                text: productType,
                selected: true
            }));
            // Set the value of pump dropdown
            $('#pumb_id').empty().append($('<option>', {
                value: qty,
                text: qty,
                selected: true
            }));
